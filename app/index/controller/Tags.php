...
class Tags extends BaseController
{
    ...
    {
        // 获取配置
        $config = get_addons_config('addons','tags');

        $this->view->assign('seo_title', $config['seo_title']);
        $this->view->assign('seo_keywords', $config['seo_keyword']);
        $this->view->assign('seo_desc', $config['seo_desc']);
        return $this->view->fetch('tags/'.$config['tags']);
    }
